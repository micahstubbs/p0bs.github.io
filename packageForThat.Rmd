...
We're now ready to plot the data. When we do so, some regional trends are immediately apparent.
...
And that's it! Hopefully, this has given you a quick appreciation of the variety of techniques that you can employ in R.
